<?php
// /src/api/kitchen/get_kitchen_orders.php - CORRECCIÓN DEFINITIVA DE HORA
...
try {
    if (!isset($_SESSION['user_id']) || !in_array($_SESSION['rol_id'], [3, 5])) { // Jefe de cocina o Encargado de barra
    ...
    // ✅ CORRECCIÓN: Usamos `batch_timestamp` y le cambiamos el nombre a `added_at`.
    // El JavaScript seguirá funcionando sin cambios, pero ahora recibirá la hora correcta.
    $sql = "
        SELECT 
            od.detail_id,
            od.order_id,
            ...
            od.special_notes,
            od.item_status,
            od.batch_timestamp AS added_at, -- ¡ESTA ES LA LÍNEA CLAVE!
            od.service_time,
            o.order_time,
            rt.table_number,
            u.id AS server_id,
